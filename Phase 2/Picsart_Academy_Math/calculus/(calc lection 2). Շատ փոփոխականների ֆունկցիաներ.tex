...
\section{Շատ փոփոխականների ֆունկցիաներ}
...
\subsection{Կուտակման կետ}

\textbf{Սահմանում:} Դիցուք $E \subseteq \mathbb{R}^m$։ $x_0 \in \mathbb{R}^m$ կետը կոչվում է $E$ բազմության \textbf{կուտակման կետ}, եթե $x_0$-ի ցանկացած $B(a, \varepsilon)$ շրջակայքում $E$-ի անվերջ թվով կետեր կան առկա։ 
$E$ բազմության կուտակման կետերի բազմությունը նշանակենք $E'$-ով:

\textbf{Լեմմա:} Եթե $x_0$-ն $E$-ի կուտակման կետ է, ապա $\exists \{x_n\} \subset E, x_n \neq x_0$, այնպես որ $x_n \overset{n \to \infty}{\longrightarrow} x_0$։ Ճիշտ է նաև հակառակ պնդումը։

\textbf{Ապացույց:} $E$ բազմության կուտակման կետերի բազմությունը նշանակենք $E'$-ով։ Ունենք, որ $x_0 \in E' \implies \forall \varepsilon > 0 \ \exists x_{\varepsilon} \in E \text{ s.t. } x \in B(x_0, \varepsilon)$։

$\varepsilon$-ը նշանակենք $\frac{1}{n} \implies \exists x_n \in E \text{ s.t. } x_n \in B(x_0, \frac{1}{n})$։

\begin{itemize}
    \item $n := 1 \implies \exists x_1 \in E \text{ s.t. } x_1 \in B(x_0, 1)$
    \item $n := 2 \implies \exists x_2 \in E \text{ s.t. } x_2 \in B(x_0, \frac{1}{2})$
\end{itemize}
...
\subsection{Շատ փոփոխականի ֆունկցիաներ}

\textbf{Սահմանում 1:} Դիցուք $E \subseteq \mathbb{R}^m$։ $f: E \to \mathbb{R}$ արտապատկերմանը կանվանենք $m$ փոփոխականի ֆունկցիա։
...
\begin{itemize}
    ...
    \item $V(h, r) = \pi r^2 h$
    \item $V(a, b, c) = a \cdot b \cdot c$
\end{itemize}

\textbf{Սահմանում 2: (Էվկլիդեսյան նորմ)} Կասենք, որ $A \in \mathbb{R}$ թիվը հանդիսանում է $f: E \to \mathbb{R}$ ֆունկցիայի սահման $x_0 \in E'$ կետում, եթե $\forall \varepsilon > 0 \ \exists \delta = \delta(\varepsilon) > 0 \text{ s.t. } 0 < \|x - x_0\| < \delta, x \in E \implies |f(x) - A| < \varepsilon$։ 
\textit{Հարթության վրա սա δ շառավղով շրջան է (բաց գունդ):}

\textbf{Սահմանում 3: (Կոորդինատային)} Դիցուք $x \in E, x = (x^1, x^2, \dots, x^m)$ և $x_0 \in E', x_0 = (x_0^1, x_0^2, \dots, x_0^m)$։ 
...
\textit{Սա 2δ′ կողմով քառակուսի է (բաց խորանարդ):}

\textbf{Ցույց տանք, որ (3) $\implies$ (2)}
...
\subsection{Թեորեմ: Կոշիի և Հայնեի սահմանումների համարժեքությունը}
...
\subsubsection{Ապացույց: Անհրաժեշտություն}
...
\subsubsection{Ապացույց: Բավարարություն}
...
\subsection{Թեորեմ: Սահմանի գոյության Կոշիի պայմանը}
