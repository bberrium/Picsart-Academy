...
\section{Ֆունկցիայի մասնակի աճ և մասնակի ածանցյալ}

Դիցուք տրված է $f: D \to \mathbb{R}$, որտեղ $D \subseteq \mathbb{R}^2$-ը բաց ենթաբազմություն է։

\textbf{Սահմանում}: $f$ ֆունկցիայի \textbf{մասնակի աճ} ըստ $x$-ի (ըստ $y$-ի) $(x_0, y_0) \in D$ կետում կոչվում է հետևյալ արտահայտությունը.
...
\textbf{Սահմանում:} $f$-ի \textbf{լրիվ աճ} $(x_0, y_0) \in D$ կետում կոչվում է հետևյալ արտահայտությունը.

$$\Delta f = f(x_0 + \Delta x, y_0 + \Delta y) - f(x_0, y_0)$$

\textbf{Սահմանում:} $f$-ի \textbf{մասնակի ածանցյալ} ըստ $x$-ի $(x_0, y_0)$ կետում կոչվում է հետևյալ սահմանը (վերջավոր կամ անվերջ).

$$\lim_{\Delta x \to 0} \frac{f(x_0 + \Delta x, y_0) - f(x_0, y_0)}{\Delta x} \equiv \frac{\partial f}{\partial x}(x_0, y_0)$$

կամ $f'_x(x_0, y_0)$։

\textbf{Սահմանում:} $f$-ի մասնակի ածանցյալ ըստ $y$-ի $(x_0, y_0)$ կետում կոչվում է.
...
\textbf{Թեորեմ}: Եթե $\exists f'_x, f'_y$-ը $(x_0, y_0) \in D$ կետում և մասնակի ածանցյալները անընդհատ են $(x_0, y_0)$-ի որոշ շրջակայքում, ապա ֆունկցիայի աճը կարող ենք ներկայացնել հետևյալ կերպ.
...
\textbf{Սահմանում:} $f: D \to \mathbb{R}$ ($D \subseteq \mathbb{R}^2$) ֆունկցիան կոչվում է \textbf{դիֆերենցելի} $(x_0, y_0) \in D$ կետում, եթե այդ կետում ֆունկցիայի աճը կարելի է ներկայացնել այս կերպ.

$$\Delta f = A\Delta x + B\Delta y + o(\sqrt{\Delta x^2 + \Delta y^2})$$

որտեղ $A, B \in \mathbb{R}$։

Շատ փոփոխականի ֆունկցիաների դեպքում հակառակ պնդումը ճիշտ չէ՝ կարող ենք ներկայացնել այս տեսքով => մասնակի ածանցյալները գոյություն ունեն (A-ն x-ի մասնակի ած․, B-ն y-ի), \textit{բայց պարտադիր չէ, որ լինեն անընդհատ}։
