...
\section{Լապլասի լոկալ թեորեմը}

\textbf{Դիտարկենք $n$ անկախ փորձ:}
$P_n(m) = C_n^m p^m q^{n-m} = \frac{n!}{m!(n-m)!} p^m q^{n-m}$
$A$-ի $m$ անգամ հանդես գալը:

Ֆակտորիալը մեծ թվերի համար հարմար չէ, դրա համար օգտվում ենք \textbf{Ստիրլինգի թեորեմից}:
