...
**Թեորեմ:** Դիցուք ունենք $f: E \to \mathbb{R}$ ($E \subset \mathbb{R}^m$), $x_0 \in E$, $x_0 = (x_0^1, x_0^2, \dots, x_0^{i-1}, x_0^i, x_0^{i+1}, \dots, x_0^m)$: Ունենք նաև, որ $f$-ը $x_0$-ում անընդհատ է:
...
**Ապացույց:** Դիցուք $y \to x_0^i \implies x \to x_0$:

Այլ կերպ ասած՝ $y \to x_0^i \implies |f(x) - f(x_0)| \implies \varphi(y) \to f(x_0)$:

$x^i \to x_0 \implies \varphi(x) \to f(x_0)$:
...
**Ապացույց:** Վեկտորային զուգամիտությունից կոորդինատային:
...
**Վեյերշտրասի I թեորեմ:** Եթե $f: E \to \mathbb{R}$, $E \subset \mathbb{R}^m$ բազմությունը կոմպակտ է, և $f$-ն անընդհատ է $E$ վրա, ապա այն սահմանափակ է:
