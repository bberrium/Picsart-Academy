...
- [Հիմնական սահմանումներ և բաց բազմություններ](#հիմնական-սահմանումներ-և-բաց-բազմություններ)
  - [Թեորեմ: Բաց և փակ բազմությունների կապը](#թեորեմ-բաց-և-փակ-բազմությունների-կապը)
  - [Ուռուցիկ բազմություններ](#ուռուցիկ-բազմություններ)
  - [Կոմպակտ բազմություններ և Բորելի լեմման](#կոմպակտ-բազմություններ-և-բորելի-լեմման)
  - [1. Կոմպակտ բազմության սահմանափակությունը](#1-կոմպակտ-բազմության-սահմանափակությունը)
  - [2. Կոմպակտ բազմության փակությունը](#2-կոմպակտ-բազմության-փակությունը)
- [Բորելի լեմմա](#բորելի-լեմմա)


## Հիմնական սահմանումներ և բաց բազմություններ
...
**Փակ բազմություն**: $F$ բազմությունը կոչվում է փակ, եթե $F'\subset F$ ($F'$ - կուտակման կետերի բազմություն)

---

### Թեորեմ: Բաց և փակ բազմությունների կապը
...
1. Անհրաժեշտություն ($\implies$)

**Պայման:** Ենթադրենք $F$-ը փակ բազմություն է։

**Պահանջ**: Ապացուցել, որ $V = \mathbb{R} \setminus F$-ը բաց է։
...
2. Բավարարություն ($\impliedby$)

**Պայման:** Ենթադրենք $V = \mathbb{R} \setminus F$-ը բաց բազմություն է։

**Պահանջ:** Ապացուցել, որ $F$-ը փակ է (այսինքն՝ $\forall x \in F' \implies x \in F$)։
...
**Եզրային կետի սահմանումը**: $a \in \mathbb{R}^m$ կետը կոչվում է $F \subseteq \mathbb{R}^m$ բազմության եզրային կետ, եթե $a$ կետի կամայական շրջակայքում կան թե՛ $F$ բազմությանը պատկանող և թե՛ $F$-ին չպատկանող կետեր:
...
**Սահմանում։** $L \in \mathbb{R}^m$ բազմությունը կոչվում է բեկյալ, եթե գոյություն ունի կետերի այնպիսի $\{x_0, x_1, \dots, x_n\} \subseteq \mathbb{R}^m$ բազմություն, որ $L$ բազմությունը հանդիսանում է այդ կետերը միացնող հատվածների միավորումը:
...
**Սահմանում։** $L \in \mathbb{R}^m$ բազմությունը կոչվում է կապակցված, եթե $\forall a, b \in F \quad \exists L \subset F, \text{  s.t.  }  x_0 = a, x_n = b$
...
### Կոմպակտ բազմություններ և Բորելի լեմման

**Կոմպակտ բազմության սահմանումը:**
...
---
### 1. Կոմպակտ բազմության սահմանափակությունը

**Թեորեմ:** Եթե $F \subset \mathbb{R}^m$ բազմությունը կոմպակտ է, ապա այն սահմանափակ է։
...
### 2. Կոմպակտ բազմության փակությունը

**Թեորեմ:** Եթե $F \subset \mathbb{R}^m$ բազմությունը կոմպակտ է, ապա այն փակ է։

**Ապացույց** (հակասող ենթադրությամբ):
...
Այս ընտանիքի միավորումը ծածկում է ամբողջ տարածությունը՝ բացի $x_0$ կետից՝
...
**Պայման:** Դիցուք $F \subseteq \mathbb{R}^2$ բազմությունը փակ է և սահմանափակ:

**Պահանջ:** Ապացուցել, որ $F$-ը կոմպակտ է, այսինքն՝ նրա կամայական $\{G_\alpha\}_{\alpha \in I}$ բաց ծածկույթից կարելի է առանձնացնել վերջավոր ենթածածկույթ:

**Ենթադրություն (հակասող):** Ենթադրենք $F$-ը չի կարելի ծածկել $\{G_\alpha\}$ համակարգի վերջավոր թվով տարրերով:
