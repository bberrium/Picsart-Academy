...
## 1. Naive Bayes 
### Բայեսի թեորեմը (Bayes' Theorem)

Դասակարգման հիմքում ընկած է հետևյալ բանաձևը.

$$P(C\vert{}X) = \frac{P(X\vert{}C)P(C)}{P(X)}$$

- **$P(C\vert{}X)$ (Posterior):** Հավանականությունը, որ տվյալ $X$ հատկանիշների դեպքում օբյեկտը պատկանում է $C$ դասին:
    
- **$P(X\vert{}C)$ (Likelihood):** Տվյալ դասի դեպքում $X$ հատկանիշի հանդիպման հավանականությունը:
    
- **$P(C)$ (Prior):** Դասի ընդհանուր հավանականությունը (մինչև տվյալները տեսնելը):
    
- **$P(X)$ (Evidence):** Տվյալների հանդիպման ընդհանուր հավանականությունը:
